...
function setMood(emoji, label) {
    ...
    confetti({ particleCount: 30, colors: ['#FFB6C1', '#DCD0FF'] });
}
...
function addTask() {
    ...
    li.innerHTML = `<input type="checkbox" onchange="toggleTask(this)" style="width:20px;height:20px;accent-color:#9370DB"><span>${input.value}</span>`;
    list.appendChild(li);
    input.value = '';
